...
export const PokedexDetail: FC = () => {
  ...
  return (
    <SCContainerDetail backgroundColor={(background as any)[pokeSelected?.types[0]]}>
      <SCBackgroundOverlay backgroundColor={(background as any)[pokeSelected?.types[0]]}/>
      <SCContainerCardDetail
